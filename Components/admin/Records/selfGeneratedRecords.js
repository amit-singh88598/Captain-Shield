...
import { getSelfGeneratedUsersProfile } from "../../../actions/vendor";
...
export default function SelfGeneratedRecords() {
  const classes = useStyles();
  const [profile, setProfile] = useState(null);
  useEffect(async () => {
    await getSelfGeneratedUsersProfile((error, result) => {
      if (error) {
        console.log(error);
      } else {
